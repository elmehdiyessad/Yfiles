                ...
                <nav className="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
                    <div className="container-fluid">
                        ...
                        <div className="d-inline-flex">
                            <Avatar alt="profil" src={Img} />
                            <UncontrolledDropdown setActiveFromChild>
                                <DropdownToggle tag="a" className="nav-link" caret  style={{color:"#223B62"}}>
                                </DropdownToggle>
                                <DropdownMenu className="d">
                                    <DropdownItem tag="a" href="/blah" className="d-inline-flex pl-2"> <Avatar alt="profil" src={Img} className="mr-2"/> <h6 className="mt-auto">Username</h6> </DropdownItem>
